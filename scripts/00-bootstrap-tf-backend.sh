...
echo "  cd terraform && terraform init -migrate-state -backend-config=backend.hcl"
echo ""
echo "Next (Jenkins): create job with Script Path jenkins/Jenkinsfile.infra; default STAGE=plan."
